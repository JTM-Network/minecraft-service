...
@Document("bugs")
data class Bug(val id: UUID = UUID.randomUUID(), val pluginId: UUID, val accountId: UUID, var comment: String, var fixed: Boolean = false, val created: Long = System.currentTimeMillis()) {
