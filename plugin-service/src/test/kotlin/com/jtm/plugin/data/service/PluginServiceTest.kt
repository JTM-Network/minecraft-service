...
class PluginServiceTest {
    ...
    fun updateName_thenFailedUpdate() {
        val returned = pluginService.updateName(nullDto)
    ...
    fun updateName_thenNotFound() {
        ...
        val returned = pluginService.updateName(dto)
    ...
    fun updateBasicDesc_thenFailedUpdate() {
        val returned = pluginService.updateBasicDesc(nullDto)
    ...
    fun updateBasicDesc_thenNotFound() {
        ...
        val returned = pluginService.updateBasicDesc(dto)
    ...
    fun updateDesc_thenFailedUpdate() {
        val returned = pluginService.updateDesc(nullDto)
    ...
    fun updateDesc_thenNotFound() {
        ...
        val returned = pluginService.updateDesc(dto)
    ...
    fun updateVersion_thenFailedUpdate() {
        val returned = pluginService.updateVersion(nullDto)
    ...
    fun updateVersion_thenNotFound() {
        ...
        val returned = pluginService.updateVersion(dto)
    ...
    fun updateActive_thenFailedUpdate() {
        val returned = pluginService.updateActive(nullDto)
    ...
    fun updateActive_thenNotFound() {
        ...
        val returned = pluginService.updateActive(dto)
    ...
    fun updatePrice_thenFailedUpdate() {
        val returned = pluginService.updatePrice(nullDto)
    ...
    fun updatePrice_thenNotFound() {
        ...
        val returned = pluginService.updatePrice(dto)
