...
class FileSystemServiceTest {
    ...
    private val fileDto: FileDTO = mock()
    ...
    fun setup() {
        ...
        `when`(fileDto.name).thenReturn("/test")
        `when`(fileDto.path).thenReturn("/test")
    }

//    @Test
//    fun getVersions() {
//        `when`(fileSystemHandler.listFiles(anyString())).thenReturn(Flux.just(fileDto))
//
